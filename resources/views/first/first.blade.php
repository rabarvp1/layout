...
<div class="row ">
    ...
    <div class="col-xl-3 col-lg-3 col-6 text-center mb-4 " >
        <a href="/product" class=" link-underline link-underline-opacity-0">
            <div class=" d-flex justify-content-between align-items-center   card-shadow btn_icon product-color rounded-4 mt-5 " >
    ...
    <div class="col-xl-3 col-lg-3 col-6 text-center mb-4 " >
        <a href="/sale/view" class=" link-underline link-underline-opacity-0">
            <div class=" d-flex justify-content-between align-items-center  card-shadow btn_icon inventory-color rounded-4 mt-5" >
    ...
    <div class="col-xl-3 col-lg-3 col-6 text-center mb-4 " >
        <a href="/buy" class=" link-underline link-underline-opacity-0">
            <div class=" d-flex justify-content-between align-items-center  card-shadow btn_icon product-color rounded-4 mt-5" >
                ...
                <span class=" mr-2 ">Purchease</span>
            </div>
        </a>
    </div>
    <div class="col-xl-3 col-lg-3 col-6 text-center mb-4 " >
        <a href="/sell" class=" link-underline link-underline-opacity-0">
            <div class=" d-flex justify-content-between align-items-center card-shadow btn_icon sale-color rounded-4 mt-5" >
        ...
        <a href="/sell" class=" link-underline link-underline-opacity-0">
            <div class=" d-flex justify-content-between align-items-center card-shadow btn_icon sale-color rounded-4 mt-5" >
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
                    ...
                    <g fill="none" stroke="#f4efef" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
    ...
    <div class="col-xl-3 col-lg-3 col-6 text-center mb-4 " >
        <a href="/income" class=" link-underline link-underline-opacity-0">
            <div class=" dash-card d-flex justify-content-between align-items-center card-shadow btn_icon report-color mt-5  " >
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
                    <rect width="24" height="24" fill="none" />
                    <g fill="none" stroke="#f4efef" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="#f4efef">
